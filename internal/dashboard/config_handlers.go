...
func (d *Dashboard) registerConfig(mux *http.ServeMux) {
	...
	mux.HandleFunc("PUT /api/v1/config", d.authAuditWrap(d.handleUpdateConfig))
	mux.HandleFunc("GET /api/v1/config/ratelimit", d.authWrap(d.handleGetRateLimitConfig))
	mux.HandleFunc("PUT /api/v1/config/ratelimit", d.authAuditWrap(d.handleUpdateRateLimitConfig))
	mux.HandleFunc("GET /api/v1/config/bot", d.authWrap(d.handleGetBotConfig))
	mux.HandleFunc("PUT /api/v1/config/bot", d.authAuditWrap(d.handleUpdateBotConfig))
	mux.HandleFunc("POST /api/v1/config/reload", d.authAuditWrap(d.handleReloadConfig))
